...
(function (root) {
  ...
  const T = {
    ko: {
      ...
      'my.title_detail':       '📝 내 이전 세부포트 조회·수정',
      'my.title_holiday':      '📝 내 이전 공휴일 조회·수정',
      'my.title_network':      '📝 내 이전 네트워크 변경 조회·수정',
      ...
      'edit.mode_desc_batch':  '이전 제출을 모두 불러왔습니다. 필요한 부분만 수정·추가·삭제 후 <b>전체 제출</b>을 누르면 기존 항목이 <b>일괄 갱신</b>됩니다.',
      'edit.loaded_msg':       '✏️ 이전 제출 {n}건을 불러왔습니다. 필요한 부분을 수정·추가·삭제 후 아래 [전체 제출]을 눌러주세요.',
      'edit.save':             '수정 저장',
    ...
    en: {
      ...
      'my.title_detail':       '📝 View/Edit My Sub-Ports',
      'my.title_holiday':      '📝 View/Edit My Holidays',
      'my.title_network':      '📝 View/Edit My Network Changes',
      'my.rows_unit':          ' rows',
      'my.total_qty':          'Total qty',
      ...
      'edit.mode_desc_batch':  'All previous entries loaded. Edit, add, or delete rows, then click <b>Submit All</b> to update the batch in place.',
      'edit.loaded_msg':       '✏️ Loaded {n} previous entries. Edit / add / delete rows, then click [Submit All] below.',
