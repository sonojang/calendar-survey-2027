...
(function (root) {
  ...
  const T = {
    ko: {
      ...
      'adm.col.action':        '액션',
      'adm.col.company':       '회사',
      'adm.col.company_req':   '신청회사',
      'adm.col.division':      '본부',
      'adm.col.team':          '팀',
      'adm.col.country':       '국가',
      'adm.col.region':        '지역',
      'adm.col.type':          '타입',
      'adm.col.jangkum_b':     '장금B',
      'adm.col.heunga_b':      '흥아B',
      'adm.col.jangkum':       '장금',
      'adm.col.heunga':        '흥아',
      'adm.col.yjc_jangkum':   'YJC장금',
      'adm.col.yjc_heunga':    'YJC흥아',
      'adm.col.qty':           '수량',
      'adm.col.ship_method':   '배송방법',
      'adm.col.port':          'Port',
      'adm.col.pic':           '담당자',
      'adm.col.contact':       '연락처',
      'adm.col.address':       '주소',
      'adm.col.note':          '비고',
      'adm.col.submitter':     '입력자',
      'adm.col.submitter_office':'입력자 소속',
      'adm.col.registrar':     '등록자',
      'adm.col.registrar_office':'등록자 소속',
      'adm.col.email':         '이메일',
      'adm.col.date':          '날짜',
      'adm.col.weekday':       '요일',
      'adm.col.holiday_en':    '공휴일명 (EN)',
      'adm.col.branch':        '지점/사무소',
      'adm.col.change_field':  '변경항목',
      'adm.col.old_value':     '기존값',
      'adm.col.new_value':     '변경값',
      'adm.col.memo':          '메모',
      'adm.col.company_ship':  '배송처 사명',
      'adm.col.etd':           'ETD',
      'adm.col.eta':           'ETA',
      'adm.col.bl_no':         'BL 번호',
      'adm.col.vessel':        '선박명',
      'adm.col.special':       '특이사항',
      'adm.col.receive_status':'수령상태',
      'adm.col.submitted_at':  '제출시각',
      'adm.col.registered_at': '등록시각',
      'adm.col.not_received':  '미수령',
      'adm.col.no_response':   '아직 응답이 없습니다',
      ...
      'adm.sum.detail':        '세부포트',
      'adm.sum.holiday':       '공휴일',
      'adm.sum.network':       '네트워크 변경',
      'adm.sum.rows':          '건',
      'adm.sum.copies':        '부',
      'adm.sum.unspecified':   '미지정',
    },
    ...
    en: {
      ...
      /* ---------- Admin - Table Columns ---------- */
      'adm.col.action':        'Actions',
      'adm.col.company':       'Company',
      'adm.col.company_req':   'Requesting Co.',
      'adm.col.division':      'Division',
      'adm.col.team':          'Team',
      'adm.col.country':       'Country',
      'adm.col.region':        'Region',
      'adm.col.type':          'Type',
      'adm.col.jangkum_b':     'Sinokor B',
      'adm.col.heunga_b':      'Heung-A B',
      'adm.col.jangkum':       'Sinokor',
      'adm.col.heunga':        'Heung-A',
      'adm.col.yjc_jangkum':   'YJC Sinokor',
      'adm.col.yjc_heunga':    'YJC Heung-A',
      'adm.col.qty':           'Qty',
      'adm.col.ship_method':   'Shipping Method',
      'adm.col.port':          'Port',
      'adm.col.pic':           'Contact Person',
      'adm.col.contact':       'Contact',
      'adm.col.address':       'Address',
      'adm.col.note':          'Note',
      'adm.col.submitter':     'Submitter',
      'adm.col.submitter_office':'Submitter Office',
      'adm.col.registrar':     'Registrar',
      'adm.col.registrar_office':'Registrar Office',
      'adm.col.email':         'Email',
      'adm.col.date':          'Date',
      'adm.col.weekday':       'Weekday',
      'adm.col.holiday_en':    'Holiday Name (EN)',
      'adm.col.branch':        'Branch / Office',
      'adm.col.change_field':  'Changed Field',
      'adm.col.old_value':     'Previous Value',
      'adm.col.new_value':     'New Value',
      'adm.col.memo':          'Memo',
      'adm.col.company_ship':  'Company / Branch',
      'adm.col.etd':           'ETD',
      'adm.col.eta':           'ETA',
      'adm.col.bl_no':         'B/L No.',
      'adm.col.vessel':        'Vessel',
      'adm.col.special':       'Remarks',
      'adm.col.receive_status':'Receipt Status',
      'adm.col.submitted_at':  'Submitted at',
      'adm.col.registered_at': 'Registered at',
      'adm.col.not_received':  'Not received',
      'adm.col.no_response':   'No responses yet',

      /* ---------- Admin - Summary ---------- */
      'adm.sum.title':         'Response Status',
      'adm.sum.domestic':      'Domestic',
      'adm.sum.overseas':      'Overseas',
      'adm.sum.detail':        'Sub-Ports',
      'adm.sum.holiday':       'Holidays',
      'adm.sum.network':       'Network Changes',
      'adm.sum.rows':          'rows',
      'adm.sum.copies':        'copies',
      'adm.sum.unspecified':   'Unspecified',
    }
  };
